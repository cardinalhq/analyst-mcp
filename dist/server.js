...
registerTool({
    ...
    inputSchema: {
        ...
        properties: {
            ...
            question: {
                type: "string",
                description: "Optional question to filter the graph to only relevant tables. Highly recommended to provide this for better results.",
            },
        },
    },
...
registerTool({
    name: "CheckHealth",
    description: "Check health status of the server. When profileId is provided, returns whether the profile graph is ready (ready: true/false). When datasourceId is provided, returns whether the datasource is ready (ready: true/false).",
    inputSchema: {
        type: "object",
        properties: {
            profileId: {
...
registerTool({
    ...
    inputSchema: {
        ...
        properties: {
            ...
            question: {
                type: "string",
                description: "Original question - required for LLM validation and diagram generation",
            },
        },
    },
    outputSchema: { type: "object" },
...
registerTool({
    ...
    inputSchema: {
        ...
        properties: {
            id: {
                type: "string",
                description: 'Unique resource ID/URI (e.g., "glossary-customer", "rule-revenue-calc")',
            },
